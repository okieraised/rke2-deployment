  ...
  template:
    ...
    spec:
      ...
      initContainers:
        ...
        {{- end }}
      {{- end }}
      {{- if $deploymentValues.Values.runtimeClassName }}
      runtimeClassName: {{ $deploymentValues.Values.runtimeClassName }}
      {{- end }}
      {{- if $deploymentValues.Values.shareProcessNamespace }}
      shareProcessNamespace: {{ $deploymentValues.Values.shareProcessNamespace }}
      {{- end }}
      containers:
